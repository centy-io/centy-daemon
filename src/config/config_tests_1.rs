use super::*;
    ...
    fn test_custom_field_def_serialization() {
        let field = mdstore::CustomFieldDef {
            name: "environment".to_string(), field_type: "enum".to_string(), required: true,
        ...
        let deserialized: mdstore::CustomFieldDef = serde_json::from_str(&json).expect("Should deserialize");
