...
use crate::item::generic::storage::generic_restore;
...
use crate::server::proto::{RestoreIssueRequest, RestoreIssueResponse};
use crate::server::resolve::resolve_issue_id;
use crate::server::structured_error::to_error_json;
use tonic::{Response, Status};

pub async fn restore_issue(
    req: RestoreIssueRequest,
    ...
    match generic_restore(project_path, &item_config, &issue_id).await {
        Ok(()) => {
