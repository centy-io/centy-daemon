...
pub async fn open_in_temp_workspace(
    ...
    let err_response = |error: String, issue_id: String, dn: u32| {
    ...
    let issue = match resolve_issue(project_path, &req.issue_id).await {
        Ok(i) => i,
        Err(e) => return err_response(to_error_json(&req.project_path, &e), String::new(), 0),
    };
    ...
    .await
    {
        ...
        Err(e) => err_response(to_error_json(&req.project_path, &e), String::new(), 0),
    }
}
