...
impl CentyDaemon for CentyDaemonService {
    ...
    async fn create_pr(
        ...
        handlers::pr_create::create_pr(request.into_inner()).await
    }
    ...
    async fn get_pr(
        ...
        handlers::pr_read::get_pr(request.into_inner()).await
    }
    ...
    async fn get_pr_by_display_number(
        ...
        handlers::pr_read::get_pr_by_display_number(request.into_inner()).await
    }
    ...
    async fn get_prs_by_uuid(
        ...
        handlers::pr_by_uuid::get_prs_by_uuid(request.into_inner()).await
    }
    ...
    async fn list_prs(
        ...
        handlers::pr_list::list_prs(request.into_inner()).await
    }
    ...
    async fn update_pr(
        ...
        handlers::pr_update::update_pr(request.into_inner()).await
    }
    ...
    async fn delete_pr(
        ...
        handlers::pr_delete::delete_pr(request.into_inner()).await
    }
    ...
    async fn soft_delete_pr(
        ...
        handlers::pr_soft_delete::soft_delete_pr(request.into_inner()).await
    }
    ...
    async fn restore_pr(
        ...
        handlers::pr_restore::restore_pr(request.into_inner()).await
    }
    ...
    async fn get_next_pr_number(
        ...
        handlers::pr_read::get_next_pr_number(request.into_inner()).await
    }
