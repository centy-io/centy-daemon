...
pub fn set_log_file_path(path: String) { let _ = LOG_FILE_PATH.set(path); }
...
impl Default for LogConfig {
    fn default() -> Self {
        let log_dir = dirs::home_dir()
            ...
            .join(".centy").join("logs");
        Self { log_dir, log_level: Level::INFO, json_format: false, rotation: Rotation::DAILY }
    }
}
#[cfg(test)]
