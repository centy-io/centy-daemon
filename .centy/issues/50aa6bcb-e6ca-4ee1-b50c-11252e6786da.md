...
The features/compaction system will be managed by the external Centy CLI rather than the daemon. This simplifies the daemon’s responsibilities and keeps it focused on core issue/item management.
