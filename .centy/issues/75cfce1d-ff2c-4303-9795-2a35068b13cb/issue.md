...
2. Parse name/email pairs
3. Generate slug from name (lowercase, hyphenated)
4. Skip if email already exists in users
5. Create new users (or show what would be added with `--dry-run`)
