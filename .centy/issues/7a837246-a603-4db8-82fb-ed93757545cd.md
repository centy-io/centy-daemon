...
status: open
priority: 1
createdAt: 2025-12-15T16:43:29.047401+00:00
updatedAt: 2025-12-15T16:43:29.047401+00:00
---
...
1. There’s no indication to the user that the agent will update the `plan.md` file
1. The user cannot see the agent’s progress or output
...
1. Use `exec` to replace the centy process with the agent process
1. Pipe agent output through centy and display it
1. Add progress indicators or status updates
